...
public class ItemInit {
    public static func initItems() {
        ...
        Trees.AddTree(level: 4, tree: Tree(Name: "Gold Tree", Health: 20000900, Worth: 5097970, Image: UIImage(named: "gold tree")!, Level: 4, Cost: 10));
        Trees.AddTree(level: 5, tree: Tree(Name: "Diamond Tree", Health: 19809900, Worth: 19868750, Image: UIImage(named: "stone tree")!, Level: 5, Cost: 10));
        Trees.AddTree(level: 6, tree: Tree(Name: "Whalen Tree", Health: 999999999, Worth: 999999999, Image: UIImage(named: "gold tree")!, Level: 6, Cost: 10));
        Trees.AddTree(level: 7, tree: Tree(Name: "Oliver Tree", Health: 2147483647, Worth: 2147483647, Image: UIImage(named: "iron tree")!, Level: 7, Cost: 10));
    }
}
